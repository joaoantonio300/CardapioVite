    ...
    <>
      <div className="font-poppins flex justify-between items-center flex-col w-[100%] h-[100vh]">
        ...
        <div className="gap-20 flex justify-center items-center flex-col w-[100%]">
          <div
            className="flex justify-center items-center bg-no-repeat bg-contain h-[36vh] w-[100%]"
          ...
          <main className="w-[85%]">
            ...
            <h1 className="font-semibold leading-8 text-4xl">Relemebre &</h1>
            <h1 className="font-semibold leading-8 text-4xl">Viva</h1>
            <p className="mt-4 text-sm sm:text-base font-extralight">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis
              magni cum incidunt, impedit nulla fugit.Omnis magni cum incidunt,
              impedit nulla fugit.
            </p>
          </main>
        </div>
        <footer className="w-[95%] flex justify-end aling-end">
          <Link to={"/lista"}>
            <button className="w-15 h-15 bg-gray-300 text-5xl rounded-sm animate-bounce">
              >
            </button>
          </Link>
        </footer>
