  ...
  return (
    <div className="overflow-hidden flex flex-col items-center gap-10 h-[100vh] bg-[#FF0000]">
      <div className="flex flex-col items-center gap-5 text-white mt-9 w-[100vw]">
        ...
        <div className="mt-9 flex flex-col font-extralight text-xl gap-10"></div>
        <form
          onSubmit={handleSubmit}
          className="flex flex-col gap-5 w-[95%] items-center"
        >
          <label>
            <span className="text-[15px] font-bold">Email</span>
            <input
              className="!shadow-red-800 bg-white text-black"
              required
              type="email"
              name="email"
              value={email}
          ...
          <label className="shadow-none">
            <span className="text-[px] font-bold">Senha</span>
            <input
              required
              className="!shadow-red-800 bg-white text-black"
              type="password"
          ...
          {!loading && (
            <button className="bg-black text-white rounded-[20px] w-[50%] p-2">
              Entrar
            </button>
          )}
          {loading && (
            <button
              disabled
              className="bg-black text-white rounded-[20px] w-[50%] p-2"
            >
              Aguarde...
            </button>
          )}
